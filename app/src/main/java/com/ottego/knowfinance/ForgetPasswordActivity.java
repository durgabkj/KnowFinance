...
import com.ottego.knowfinance.databinding.ActivityForgetPasswordBinding;
...
ActivityForgetPasswordBinding b;
    Context context;
    public String receiveOtp = "forgot/password/otp";
    public String updatePassWord = "forgot/password/update";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b=ActivityForgetPasswordBinding.inflate(getLayoutInflater());
...
//                                startActivity(intent);
    ...
    private void update() {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.POST, updatePassWord, new JSONObject(params),
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
